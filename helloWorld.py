...
import re
texts = '''This file contains the actual data for your assignment - good luck!
...
9689 from laptops to cell phones.  We can think of these computers 7750
as our personal assistants who can take care of many things
on our behalf.  The hardware in our current-day computers 
5429 is essentially built to continuously ask us the question, 7728
6420 What would you like me to do next?
...
7890 could be very helpful to us if we only knew the language to
speak to explain to the computer what we would like it to 
2227 do next.  If we knew this language, we could tell the 
computer to do tasks on our behalf that were repetitive.  
Interestingly, the kinds of things computers can do best
3894 are often the kinds of things that we humans find boring
and mind-numbing.
...
354 but counting the words and telling you how many times
the 3706 most 2557 used 9931 word was used is very easy for the
 computer:
...
165 that humans are not is why you need to become
...
6199 with what is next?  If your computer is rated 9270
...
or 6514 flash 1773 memory 9977 (typically found in USB sticks and portable
 music players).
...
1048 retrieve data that might not always be up.  So in a sense,
...
4337 so we can talk about these different parts as we write our programs. 1999
...
3411 of writing these instructions down and getting the instructions to 
be correct programming.
7239 
9981 Understanding programming 3337
6506 3511 7150
...
8799 There is a skill and art in constructing the story, and skill in 9749
story writing is improved by doing some writing and getting some
7581 feedback.  In programming, our program is the story and the 8966
problem you are trying to solve is the idea.

itemize

Once you learn one programming language such as Python, you will 
find 6358 it 8491 much 5538 easier to learn a second programming language such
...
writing. 6977  3377 We 7638 start reading and explaining programs, then we write 
...
6957 have very special meaning to Python.  When Python sees these words in 
...
4573 sit, stay, and fetch.  When you talk to a dog and 2726
...
I 9020 wish 3952 more 7934 people would walk to improve their overall health, 
...
assert 4666  1998  5647  else      if        pass      yield    
 break     except    import    print              
class     exec      in        raise              
continue  finally   is        return             
def       for       lambda    try

8953 That is it, and unlike a dog, Python is already completely trained.
...
by 7305 a 9946 string 844 of text of our choosing enclosed in single quotes.
...
3757 a terminal or command window and you will type python and 
the Python interpreter will start executing in interactive mode
and appear somewhat as follows:
interactive mode

The 299 >>> 6711 prompt 4814 is the Python interpreter's way of asking you, What
...
8083 the beginning. 9534

Writing a program

2115 Typing commands into the Python interpreter is a great way to experiment 
